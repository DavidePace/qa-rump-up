...
nor to the "New Settings Page" Carousel and are of secondary importance. They are all Acceptance tests)
...
| 3           | Normal    | click on "<#.profile_name>" to open the Profile page |
| 4           | Normal    | click on the Gear button |
| 5           | Validate  | Are the "Programmer une limite de durée d’activité" and "Contrôle parental" buttons displayed in the "Paramètres d’activité" card? |
...
| 2           | Normal    | click on the "People" tan to open the People page |
| 3           | Normal    | click on "<#.profile_name>" to open the Profile page |
| 4           | Normal    | click on the Gear button to open the Settings page|
